...
onMounted(async () => {
  ...
  updateMetaTags(
    'Nieruchomości Gminne - Gmina Dobra', 
    'Oficjalna baza danych nieruchomości i gruntów Gminy Dobra. Sprawdź wykaz mienia komunalnego.'
  );
});
...
<template>
    <!-- Hero Section -->
    <section class="relative min-h-[50vh] flex items-center justify-center text-midnight overflow-hidden py-16 md:py-24 px-4 bg-softGreen/30">
      ...
      <div class="container mx-auto relative z-10 text-center">
        ...
        <h1 class="text-4xl md:text-7xl font-black mb-6 leading-[1.1] tracking-tight font-outfit text-midnight" data-aos="fade-up">
          Wykaz Nieruchomości <br/> <span class="text-portalAccent">Gminnych</span>
        </h1>
          ...
          <form @submit.prevent="handleSearch" class="relative group">
            <div class="relative flex items-center">
              <input 
                ...
                class="w-full px-6 md:px-8 py-4 md:py-5 rounded-2xl bg-white border border-gray-100 text-midnight placeholder-gray-400 focus:outline-none transition-all duration-500 pr-16 md:pr-20 text-sm md:text-base shadow-[0_15px_40px_rgba(0,0,0,0.02)]"
              />
              <button type="submit" class="absolute right-2 md:right-3 w-10 h-10 md:w-12 md:h-12 bg-portalAccent text-white rounded-xl flex items-center justify-center hover:bg-accentHover active:scale-95 transition-all shadow-lg shadow-portalAccent/10 group">
                <i class="pi pi-search text-lg md:text-xl font-bold"></i>
              </button>
            </div>
          </form>
          <div class="mt-5 flex flex-wrap justify-center gap-3 md:gap-4 text-[9px] md:text-[11px] font-bold text-steel/60 uppercase tracking-wider">
            <button @click="searchQuery = 'Obręb Dobra'" class="hover:text-portalAccent transition-colors">Obręb Dobra</button>
            <span class="opacity-30">•</span>
            <button @click="searchQuery = '1817/1'" class="hover:text-portalAccent transition-colors">Działka 1817/1</button>
            <span class="opacity-30">•</span>
            <button @click="searchQuery = 'R'" class="hover:text-portalAccent transition-colors">Użytki Rolne (R)</button>
            <span class="opacity-30">•</span>
            <button @click="searchQuery = 'dr'" class="hover:text-portalAccent transition-colors">Drogi (dr)</button>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="pb-16 -mt-10 relative z-20 px-4">
      <div class="container mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <!-- Stat Card 1 -->
          <div class="bg-white rounded-[2rem] p-8 shadow-[0_10px_30px_rgba(0,0,0,0.03)] border border-gray-50 flex flex-col items-center md:items-start text-center md:text-left gap-6 group hover:border-portalAccent/10 hover:shadow-portalAccent/5 transition-all duration-500" data-aos="fade-up">
          ...
          <!-- Stat Card 2 -->
          <div class="bg-white rounded-[2rem] p-8 shadow-[0_10px_30px_rgba(0,0,0,0.03)] border border-gray-50 flex flex-col items-center md:items-start text-center md:text-left gap-6 group hover:border-portalAccent/10 hover:shadow-portalAccent/5 transition-all duration-500" data-aos="fade-up" data-aos-delay="100">
          ...
          <!-- Stat Card 3 -->
          <div class="bg-white rounded-[2rem] p-8 shadow-[0_10px_30px_rgba(0,0,0,0.03)] border border-gray-50 flex flex-col items-center md:items-start text-center md:text-left gap-6 group hover:border-portalAccent/10 hover:shadow-portalAccent/5 transition-all duration-500" data-aos="fade-up" data-aos-delay="200">
    ...
    <section class="py-24 px-4 bg-white overflow-hidden">
      <div class="container mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-20 items-center text-center lg:text-left">
          <div class="relative order-2 lg:order-1" data-aos="fade-right">
            ...
            <div class="relative z-10 bg-slateBg rounded-[3rem] p-4 md:p-8 shadow-inner border border-white/50">
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <!-- Symmetrical Cards (Removed sm:mt-8) -->
                <div class="bg-white p-8 rounded-[2rem] shadow-sm transform hover:-translate-y-2 transition-all duration-500 flex flex-col items-center sm:items-start text-center sm:text-left h-full">
                  <div class="w-12 h-12 bg-red-50 rounded-xl flex items-center justify-center text-portalAccent mb-5">
                    <i class="pi pi-search-plus text-xl"></i>
                  </div>
                  <h4 class="text-midnight font-black text-sm uppercase tracking-tight mb-3">Precyzyjne Wyszukiwanie</h4>
                  <p class="text-steel text-[11px] leading-relaxed font-medium">Znajdź każdą działkę po jej numerze lub obrębie w kilka sekund.</p>
                </div>
                <div class="bg-white p-8 rounded-[2rem] shadow-sm transform hover:-translate-y-2 transition-all duration-500 flex flex-col items-center sm:items-start text-center sm:text-left h-full">
                  <div class="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600 mb-5">
                    <i class="pi pi-map text-xl"></i>
                  </div>
                  <h4 class="text-midnight font-black text-sm uppercase tracking-tight mb-3">Interaktywna Mapa</h4>
                  <p class="text-steel text-[11px] leading-relaxed font-medium">Przeglądaj granice działek na podkładzie ortofotomapy GUGiK.</p>
                </div>
                <div class="bg-white p-8 rounded-[2rem] shadow-sm transform hover:-translate-y-2 transition-all duration-500 flex flex-col items-center sm:items-start text-center sm:text-left h-full">
                  <div class="w-12 h-12 bg-emerald-50 rounded-xl flex items-center justify-center text-emerald-600 mb-5">
                    <i class="pi pi-file-pdf text-xl"></i>
                  </div>
                  <h4 class="text-midnight font-black text-sm uppercase tracking-tight mb-3">Pełna Dokumentacja</h4>
                  <p class="text-steel text-[11px] leading-relaxed font-medium">Dostęp do informacji o użytkach, powierzchni i przeznaczeniu.</p>
                </div>
                <div class="bg-white p-8 rounded-[2rem] shadow-sm transform hover:-translate-y-2 transition-all duration-500 flex flex-col items-center sm:items-start text-center sm:text-left h-full">
                  <div class="w-12 h-12 bg-amber-50 rounded-xl flex items-center justify-center text-amber-600 mb-5">
                    <i class="pi pi-mobile text-xl"></i>
                  </div>
                  <h4 class="text-midnight font-black text-sm uppercase tracking-tight mb-3">Wersja Mobilna</h4>
                  <p class="text-steel text-[11px] leading-relaxed font-medium">Portal zoptymalizowany pod kątem smartfonów i tabletów.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="order-1 lg:order-2" data-aos="fade-left">
            ...
            <h2 class="text-3xl md:text-5xl font-black text-midnight mb-8 leading-tight font-outfit">Transparentny wgląd w <br/><span class="text-portalAccent">Nieruchomości Gminne</span></h2>
            <p class="text-steel text-base md:text-lg mb-10 leading-relaxed font-medium">
            ...
            <div class="flex flex-col items-center lg:items-start gap-5 mb-12">
      ...
      <div class="container mx-auto relative z-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <router-link 
            ...
            class="group p-8 md:p-10 bg-white rounded-[2.5rem] border border-gray-100 hover:border-portalAccent/10 hover:shadow-[0_30px_60px_rgba(0,0,0,0.06)] transition-all duration-500 flex flex-col items-center text-center md:items-start md:text-left"
            data-aos="fade-up"
          ...
          >
            ...
            <div class="mt-8 pt-6 border-t border-gray-50 flex items-center justify-between w-full">
    ...
    <section class="py-24 px-4 bg-white">
      <div class="container mx-auto">
        <div class="bg-midnight rounded-[3rem] p-8 md:p-16 relative overflow-hidden text-white group">
          <div class="absolute top-0 right-0 w-1/2 h-full bg-portalAccent/10 skew-x-12 transform translate-x-1/2 hidden lg:block"></div>
          ...
          <div class="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 text-center lg:text-left">
            <div class="max-w-2xl">
              <div class="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/10 border border-white/10 mb-8 mx-auto lg:mx-0">
              ...
              <h2 class="text-3xl md:text-5xl font-black mb-8 font-outfit leading-tight">Przeglądaj zasoby na <br class="hidden md:block"/> <span class="text-portalAccent">interaktywnej mapie</span></h2>
              <p class="text-white/70 text-base md:text-lg mb-10 leading-relaxed font-medium">
            ...
            <div class="relative w-full lg:w-1/3 aspect-square max-w-[280px] md:max-w-sm mx-auto" data-aos="zoom-in">
              ...
              <div class="absolute inset-0 bg-portalAccent/20 rounded-[2.5rem] -rotate-3 border border-white/10 shadow-2xl flex items-center justify-center">
                 <i class="pi pi-map-marker text-5xl md:text-7xl text-white animate-bounce"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-[2.5rem] p-10 md:p-20 relative overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.02)] border border-gray-50">
          ...
          <div class="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            <p class="text-steel text-base md:text-lg font-medium leading-relaxed mb-10">
              Gmina Dobra to dynamicznie rozwijający się region w województwie wielkopolskim. Nasz portal nieruchomości gminnych to element strategii "Inwestuj w Dobrej", mającej na celu zapewnienie przejrzystości i wsparcia dla mieszkańców oraz przyszłych inwestorów.
            </p>
